            ...
            return clients.map((client) => (
                ...
                >
                    ...
                    <div className="flex flex-col items-start justify-center gap-1.5 min-w-0">
                        ...
                        {client.endereco && (
                            <div className="flex items-center gap-2 text-text-secondary text-xs font-medium">
                                <MdLocationOn className="text-purple-400 shrink-0" />
                    ...
                    {clientFields?.map((field) => {
                        ...
                        return (
                            <div
                                key={field.id}
                                className="flex items-center text-[12px] text-text-secondary whitespace-nowrap overflow-hidden text-ellipsis min-w-0"
                            >
                                {value}
                            </div>
                        );

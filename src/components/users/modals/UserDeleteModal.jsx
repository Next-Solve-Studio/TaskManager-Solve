        ...
        >
            ...
            <DialogTitle style={{
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
                    ...
                    <span style={{ color: '#fff', fontWeight: 700, fontSize: 16 }}>Excluir Usuário</span>
                </div>
                <button
                    type="button"
                    onClick={handleClose}
            ...
            <DialogContent style={{ padding: '20px 24px', display: 'flex', flexDirection: 'column', gap: 16 }}>
                ...
                <div style={{
                    ...
                    <p style={{ color: '#fbbf24', fontSize: 12, margin: 0, lineHeight: 1.55 }}>
                        Esta ação é <strong>irreversível</strong>. O usuário perderá acesso imediato ao sistema e seus dados serão removidos permanentemente.
                    </p>
                </div>
            </DialogContent>

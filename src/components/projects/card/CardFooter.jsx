...
export default function CardFooter({ project}) {
    ...
    const {startDateInfo, expectedInfo, deliveryStatus, deliveredInfo} = useProjectsDates(project)
            ...
            <div style={{ display: "flex", gap: 6 }}>
                ...
                {project.hosting && (
                    <Tooltip title={`Hosting: ${project.hosting}`} arrow>
                        <div className="flex items-center gap-1 py-0.75 px-2.5 rounded-[7px] text-font-gray2

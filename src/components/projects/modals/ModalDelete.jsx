...
export default function ModalDelete({ open, onClose, project, onConfirm, loading }) {
    return (
        <Dialog open={open} onClose={() => !loading && onClose()} maxWidth="xs" fullWidth
        PaperProps={{ style: { background: '#171C23', border: '1px solid rgba(239,68,68,0.2)', borderRadius: 16 }}}>

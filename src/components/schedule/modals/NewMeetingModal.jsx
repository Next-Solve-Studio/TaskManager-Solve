            ...
            >
                ...
                <div className="flex gap-2">
                    <button
                        type="button"
                        onClick={onClose}
                        className="flex-1 rounded-xl py-2.5 text-sm sm:cursor-pointer font-semibold bg-bg-side border border-border-main text-text-secondary hover:bg-bg-surface"
                    >
                        Cancelar
                    </button>
                    <button

...
export function StatPill({
    ...
    return (
        <div
            className="flex items-center gap-2 py-2 px-3 rounded-3xl text-[13px] select-none overflow-visible"
            style={{
                background: finalBg,
        ...
        >
            {FinalIcon && (
                <FinalIcon style={{ color: finalColor, fontSize: 15 }} />
            )}
            <span
                style={{
                    fontSize: 18,
            ...
            <span className="text-text-secondary font-medium wrap-break-word">
                {finalLabel}
            </span>
        </div>
    );

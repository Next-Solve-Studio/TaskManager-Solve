...
export default function SideMenuItems() {
  ...
  return (
    ...
    <div
      className={`bg-linear-to-br from-bg-pure via-[#0a0a0a] to-bg-pure h-full overflow-hidden ${isOpen ? "w-58 items-start" : "w-20 items-center"} transition-all duration-300 ease-in-out  shadow-xl z-50`}
